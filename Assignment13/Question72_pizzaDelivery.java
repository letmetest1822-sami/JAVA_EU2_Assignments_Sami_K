...
public class Question72_pizzaDelivery {
	...
	public static void main(String[] args) {
		/*
		 * A pizza delivery man has a scooter and a lot of deliveries to make, he will have to refuel a few times. Refuel_times gets an ArrayList deliveries of the amount of fuel it will take to get to destinations like:
